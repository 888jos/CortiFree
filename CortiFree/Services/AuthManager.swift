...
import Foundation
// import FirebaseAuth  // Uncomment when Firebase is installed

class AuthManager: ObservableObject {
    static let shared = AuthManager()

    @Published var currentUser: String? // Will be Firebase User when SDK is added
    ...
    func signUp(email: String, password: String, displayName: String) async throws {
        // Uncomment when Firebase Auth is installed
        /*
        ...
        */
        ...
        DispatchQueue.main.async {
            self.currentUser = "test-user-\(UUID().uuidString)"
            self.isAuthenticated = true
        }
    }
