    ...
    private var categoryButtonsGrid: some View {
        VStack(spacing: 16) {
            HStack(spacing: 16) {
                CategoryButton(
                    title: "Apprendre",
                    backgroundColor: Color(hex: "DA6B10"),
                ...
                CategoryButton(
                    title: "Blog",
                    backgroundColor: Color(hex: "49288C"),
            ...
            HStack(spacing: 16) {
                CategoryButton(
                    title: "Conseils",
                    backgroundColor: Color(hex: "D953B3"),
                ...
                CategoryButton(
                    title: "Ressources",
                    backgroundColor: Color(hex: "1B7BF1"),
            ...
            VStack(spacing: 12) {
                ...
                HStack(spacing: 12) {
                    ...
                    SoundItem(
                        ...
                        startBreathingExercise(.deepRelax)
                    }
                }
                ...
                if showAllBreathing {
                    HStack(spacing: 12) {
                        SoundItem(
                            ...
                            startBreathingExercise(.energizing)
                        }
    ...
    private func handleLibrarySection(_ section: LibrarySection) {
        ...
        case .recherches:
            ...
            if let pdfPath = Bundle.main.path(forResource: "Études Cortifree", ofType: "pdf") {
                ...
                // If PDF not found in bundle, try to open from user's Documents
                let documentsPath = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask)[0]
                let pdfURL = documentsPath.appendingPathComponent("Études Cortifree.pdf")
