...
struct Exercise: Identifiable {
    ...
    static let breathingExercises: [Exercise] = [
        Exercise(id: "deep-abdominal", title: "Respiration abdominale", type: .breathing, duration: 180,
        ...
        Exercise(id: "coherence", title: "Cohérence cardiaque", type: .breathing, duration: 420,
                description: "Débutant - Stress quotidien",
                audioFileName: nil, icon: "heart.fill"),
        Exercise(id: "slow-66", title: "Respiration lente", type: .breathing, duration: 420,
        ...
        Exercise(id: "bhastrika", title: "Bhastrika", type: .breathing, duration: 300,
                description: "Avancé - Énergie intense",
                audioFileName: nil, icon: "flame.fill")
    ]

    static let sounds: [Exercise] = [
        Exercise(id: "rain", title: NSLocalizedString("sounds.rain", comment: ""), type: .sound, duration: 0,
                description: "Son apaisant de pluie",
                audioFileName: "rain.mp3", icon: "cloud.rain.fill"),
        Exercise(id: "ocean", title: NSLocalizedString("sounds.ocean", comment: ""), type: .sound, duration: 0,
                description: "Vagues relaxantes",
                audioFileName: "ocean.mp3", icon: "water.waves"),
        Exercise(id: "fire", title: NSLocalizedString("sounds.fire", comment: ""), type: .sound, duration: 0,
                description: "Crépitement du feu",
                audioFileName: "fire.mp3", icon: "flame.fill"),
        Exercise(id: "whitenoise", title: NSLocalizedString("sounds.whitenoise", comment: ""), type: .sound, duration: 0,
                description: "Bruit blanc apaisant",
                audioFileName: "whitenoise.mp3", icon: "waveform"),
        Exercise(id: "wind", title: NSLocalizedString("sounds.morning", comment: ""), type: .sound, duration: 0,
                description: "Ambiance matinale apaisante",
                audioFileName: "morning.mp3", icon: "sunrise.fill"),
        Exercise(id: "forest", title: NSLocalizedString("sounds.forest", comment: ""), type: .sound, duration: 0,
                description: "Ambiance forestière relaxante",
                audioFileName: "forest.mp3", icon: "leaf.fill"),
        Exercise(id: "stream", title: NSLocalizedString("sounds.stream", comment: ""), type: .sound, duration: 0,
                description: "Écoulement d'eau douce",
                audioFileName: "stream.mp3", icon: "drop.fill"),
        Exercise(id: "night", title: NSLocalizedString("sounds.night", comment: ""), type: .sound, duration: 0,
    ...
    static let meditations: [Exercise] = [
        ...
        Exercise(id: "body-scan", title: "Body Scan", type: .meditation, duration: 300,
                description: "Débutant - Tensions rapides",
                audioFileName: "body-scan.mp3", icon: "figure.stand"),
        Exercise(id: "mindfulness", title: "Mindfulness", type: .meditation, duration: 480,
                description: "Débutant - Observer pensées",
                audioFileName: "mindfulness.mp3", icon: "eye.fill"),
        Exercise(id: "grounding", title: "Ancrage corporel", type: .meditation, duration: 480,
        ...
        Exercise(id: "focus-clarity", title: "Méditation focus", type: .meditation, duration: 720,
                description: "Intermédiaire - Concentration",
                audioFileName: "focus-clarity.mp3", icon: "brain.head.profile"),
        Exercise(id: "yoga-nidra", title: "Méditation sommeil", type: .meditation, duration: 1200,
