//
//  AntiStressGroundingDetailView.swift
//  CortiFree
//
//  Created by Claude on 22/11/2025.
//  Grounding 5 senses exercise detail view for Anti-Stress flow
//

import SwiftUI

struct AntiStressGroundingDetailView: View {
    ...
    private let durations = [60, 120, 180, 300] // 1min, 2min, 3min, 5min
