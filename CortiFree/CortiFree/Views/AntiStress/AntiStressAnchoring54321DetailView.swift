//
//  AntiStressAnchoring54321DetailView.swift
//  CortiFree
//
//  Created by Claude on 22/11/2025.
//  Anchoring 5-4-3-2-1 exercise detail view for Anti-Stress flow
//

import SwiftUI

struct AntiStressAnchoring54321DetailView: View {
    ...
    @State private var selectedDuration: Int = 300 // 5 minutes par défaut
    ...
    private let durations = [180, 300, 420] // 3min, 5min, 7min
            ...
            VStack(spacing: 0) {
                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 24) {
                        ...
                        // Bienfaits avec badges (AVANT données scientifiques, SANS background général)
                        benefitsSection
    ...
    // MARK: - Benefits Section (SANS background général)
